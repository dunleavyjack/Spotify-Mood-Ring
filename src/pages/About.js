        ...
        <div>
            ...
            <div className="black-body d-flex justify-content-center align-items-center content-body text-center content-body">
                <div className="container flex-fill mt-5 fixed-container">
                    <h1 className="bold about-header mt-5 mb-2 black-body whiteish floating-about">about</h1>
                    ...
                    <h1 className="bold about-header mt-5 mb-2 black-body whiteish floating-about-two">privacy</h1>
                    ...
                    <h1 className="bold about-header mt-5 mb-2 black-body whiteish floating-about">mood detecting</h1>
                    ...
                    <h1 className="bold about-header mt-5 mb-2 black-body whiteish floating-about-two">contact</h1>
