        ...
        <React.Fragment>
            ...
            <div className="tan d-flex justify-content-center align-items-center text-center content-body">
                <div className="container">
                    ...
                    <h4 className="mt-3">You might be using Spotify with a Private Session, or you might not have listened to enough songs recently for the program to work.</h4>
